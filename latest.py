...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(30, 60, 93, 28))
        self.pushButton_5.setObjectName("go to home")
        self.pushButton_5.clicked.connect(self.goto_home_page)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_5.setText(_translate("MainWindow", "back to home"))
    ...
    def goto_logs_page(self):
        ...
        for number in self.data_log:
            label1 = QtWidgets.QLabel("Page 1 Content")
            label1.setText(str(number))
            layout1.addWidget(label1)
            self.page_3.setLayout(layout1)
